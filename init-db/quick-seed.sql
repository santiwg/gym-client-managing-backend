...
INSERT INTO clients (name, "lastName", "documentNumber", email, "phoneNumber", "birthDate", "registrationDate", "genderId", "bloodTypeId", "clientGoalId") VALUES 
    ('Juan', 'Pérez', '12345678', 'juan@email.com', '1234567890', '1990-05-15', CURRENT_DATE, 1, 7, 2),
    ('María', 'González', '87654321', 'maria@email.com', '0987654321', '1985-08-22', CURRENT_DATE, 2, 1, 1),
    ('Carlos', 'Rodríguez', '11223344', 'carlos@email.com', '1122334455', '1992-12-03', CURRENT_DATE, 1, 3, 4),
    ('Ana', 'Martínez', '44332211', 'ana@email.com', '4433221100', '1988-03-17', CURRENT_DATE, 2, 2, 3);
